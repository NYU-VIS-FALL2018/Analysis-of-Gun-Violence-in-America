...
d3.csv("Final_data.csv", function(error,d) {
  // c=0
  s = [0,0,0,0,0,0,0]
  incident_type =['Assault','Unknown','Robbery','Gang Wars','Suicide','Felon','Accident']
  ...
  //  data[i]['value']=s[i]
  //}
  var data = [{'incident_type':'Assault','value':s[0]},{'incident_type':'Unknown','value':s[1]},{'incident_type':'Robbery','value':s[3]},
  {'incident_type':'Suicide','value':s[6]},{'incident_type':'Gang Wars','value':s[2]},
  {'incident_type':'Felon','value':s[4]},{'incident_type':'Accident','value':s[5]}];
